...
::: notes
-   Main types of abuses that graduate students may face with authorship credit in academia
...
::: notes
-   ICMJE states that authorship credit is not justified solely by procurement of funding, data collection, or general supervision of research activities and that for authorship credit to be validated, all authors should have participated sufficiently in the research to take public responsibility for it.
:::
...
-   Authorship guidelines
    ...
    -   Fair & clear principles

    -   Credit and order

-   Prevent non-compliance

    -   Mentorship & education of graduate students

    -   Ethical issues in authorship
:::

::: notes
If the ambiguity and non-compliance continue to increase as scientific projects become more interdisciplinary with more authorships per manuscript, then the value of authorship credit could continue to decrease (Logan et al. 2017).

In conclusion, the scientific community should create and adopt a set of authorship guidelines based on fair and clear principles and ethics to determine authorship credit and order (Oberlander and Spencer 2006).

Mentorship and education of graduate students about the ethical issues involved in authorship credit may be the best way to prevent misconduct and non-compliance (Oberlander and Spencer 2006).
:::

------------------------------------------------------------------------

#### Research Misconduct and Publishing

US Office of Research Integrity ([Health & Human Services](https://ori.hhs.gov/))

"...**fabrication, falsification, or plagiarism** in proposing, performing, or reviewing research or in reporting research results", and furthermore, "...**committed intentionally, knowingly, or recklessly**, and there must be significant departure form accepted practices."

::: incremental
-   Costs

    -   Conduct of fraudulent research
...
#### Case of Danielle Dixson and sloppy coral reef science

::: incremental
-   Investigative panel at University of Delaware
...
::: notes
The panel of researchers at UD described the misconduct as the following: "... sloppiness, poor record keeping, copying and pasting within spreadsheets, errors within the papers under investigation, and deviation from established animal ethics protocols
:::
...
[No retraction](https://www.science.org/content/article/journal-declines-retract-fish-research-paper-despite-fraud-finding)
