...
Relationship between offspring size and performance may persist across generations (Benton et al. 2005, Krist 2011, Marshall et al. 2018).

**Larger offspring** vs. the *smaller offspring* (Krist 2011, Marshall et al. 2018)
...
-   No explanation for variation in offspring size within populations of the same species (Marshall et al. 2018, Stearns 1992).
...
-   Mothers trade-off benefits of size vs. number of offspring
-   Larger offspring = *performance*
-   Smaller offspring = *abundance*
-   Model can predict mean values of offspring & variation *among* populations

------------------------------------------------------------------------

#### Classic optimality theory: Smith-Fretwell model (1974)

-   Game theory incorporates density- and frequency-dependent interactions among offspring in a population (Geritz 1995, Gertiz et al. 1999).
...
- Use proportionately less vs. smaller offspring (Leishman et al. 2000, Patteresen et al. 2015, 2017)
